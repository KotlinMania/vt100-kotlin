...
This file is the quick-reference operating contract for vt100-kotlin. The longer
...
vt100-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`vt100`](https://crates.io/crates/vt100). Upstream Rust is the behavioral oracle while the
