...
kotlin {
    ...
    val xcf = XCFramework("Vt100")

    macosArm64 {
        binaries.framework { baseName = "Vt100"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Vt100"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Vt100"
        flattenPackage = "io.github.kotlinmania.vt100"
    }

    android {
        namespace = "io.github.kotlinmania.vt100"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "vt100-kotlin", version.toString())

    pom {
        name.set("vt100-kotlin")
        description.set("Kotlin Multiplatform port of doy/vt100-rus - Library for parsing terminal data")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/vt100-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/vt100-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/vt100-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/vt100-kotlin.git")
        }
    }
}
...
dependencies {
    ...
    codeqlSourceClasspath("io.github.kotlinmania:unicode-width-kotlin-jvm:0.1.13")
}
