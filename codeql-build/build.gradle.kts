...
fun registerCodeqlCompileTask(
    ...
    tasks.register<JavaExec>(taskName) {
        ...
        doFirst {
            ...
            val stubUnicodeWidth = dummySourceDir.get().file("io/github/kotlinmania/unicodewidth/UnicodeWidthStub.kt").asFile
            stubUnicodeWidth.parentFile.mkdirs()
            stubUnicodeWidth.writeText(
                "package io.github.kotlinmania.unicodewidth\n\n" +
                    "public fun Int.unicodeWidth(): Int? = 1\n" +
                    "public fun Char.unicodeWidth(): Int? = 1\n" +
                    "public fun Int.unicodeWidthCjk(): Int? = 1\n" +
                    "public fun Char.unicodeWidthCjk(): Int? = 1\n",
            )
            commonSourceFiles.add(stubUnicodeWidth)
            sourceFiles.add(stubUnicodeWidth)
